package be.bdus.rush_api.il.jwt;
...
public class JwtUtils {
    ...
    private final byte[] secret = "DitesAMesAmisQueJeMEnVaisJeParsVersDeNouveauxPaysOuLeCielEstToutBleu,DitesQueJeMEnVaisEtCEstToutCeQuiCompteDansMaVie".getBytes();
